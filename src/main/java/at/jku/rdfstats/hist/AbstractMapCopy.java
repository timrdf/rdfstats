...
public abstract class AbstractMapCopy<K,V> implements Map<K,V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapCopy() {
    }
	...
	if (keySet == null) {
		...
		public int size() {
		    return AbstractMapCopy.this.size();
		}

		public boolean contains(Object k) {
		    return AbstractMapCopy.this.containsKey(k);
		}
	    };
	}
	return keySet;
	...
	if (values == null) {
		...
		public boolean contains(Object v) {
		    return AbstractMapCopy.this.containsValue(v);
		}
	    };
	}
	return values;
    ...
    /**
     * Returns a shallow copy of this <tt>AbstractMapCopy</tt> instance: the keys
     * and values themselves are not cloned.
     *
     * @return a shallow copy of this map.
     */
    protected Object clone() throws CloneNotSupportedException {
        AbstractMapCopy<K,V> result = (AbstractMapCopy<K,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
